...
<div class="menu">
    ...
    <div class="secondary_menu">
        ...
        <button class="dropBtn" onclick="location.href='dyzuryikonsultacje.php'" style="background-color: #fff;color: #00507b">Dyżury i&nbspkonsultacje</button>
        <button class="dropBtn" onclick="location.href='planzajec.php'" >Plany zajęć</button>
    </div>
</div>
<div class="content">
