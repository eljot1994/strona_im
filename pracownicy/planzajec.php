...
<div class="menu">
    <div class="primary_menu">
        ...
        <div class="dropdown">
            <button class="dropBtn" style="cursor: default; background-color: #00507b">Pracownicy</button>
            <div class="dropList">
    ...
    <div class="secondary_menu">
        <button class="dropBtn" onclick="location.href='skladosobowy.php'" >Skład osobowy</button>
        <button class="dropBtn" onclick="location.href='dyzuryikonsultacje.php'" >Dyżury i&nbspkonsultacje</button>
        <button class="dropBtn" onclick="location.href='planzajec.php'" style="background-color: #fff;color: #00507b">Plany zajęć</button>
    </div>
</div>
<div class="content">
Plan zajęć
