    ...
    <div class="primary_menu">
        ...
        <div class="dropdown">
            ...
            <div class="dropList">
                ...
                <a href="naukaidydaktyka/tematykabadawcza.php">Tematyka naukowo-badawcza</a>
                <a href="naukaidydaktyka/projekty.php">Projekty</a>
            </div>
        </div>
        <div class="dropdown">
            <button class="dropBtn" onclick="location.href='szkoleniaikursy.php'" style="background-color: #00507b">Szkolenia i&nbspkursy</button>
        </div>
        <div class="dropdown">
