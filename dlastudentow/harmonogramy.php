...
<div class="menu">
    ...
    <div class="secondary_menu">
        <button class="dropBtn" onclick="location.href='harmonogramy.php'" style="background-color: #fff;color: #00507b">Harmonogramy</button>
        <button class="dropBtn" onclick="location.href='kierunekmatematykawtechnice.php'" >Kierunek MwT</button>
        <button class="dropBtn" onclick="location.href='przydatnepliki.php'" >Przydatne pliki</button>
    </div>
</div>
<div class="content">
Harmonogramy
