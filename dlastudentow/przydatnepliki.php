...
<div class="menu">
    <div class="primary_menu">
        ...
        <div class="dropdown">
            <button class="dropBtn" style="cursor: default; background-color: #00507b">Dla studentów</button>
            <div class="dropList">
    ...
    <div class="secondary_menu">
        <button class="dropBtn" onclick="location.href='harmonogramy.php'" >Harmonogramy</button>
        <button class="dropBtn" onclick="location.href='kierunekmatematykawtechnice.php'" >Kierunek MwT</button>
        <button class="dropBtn" onclick="location.href='przydatnepliki.php'" style="background-color: #fff;color: #00507b">Przydatne pliki</button>
    </div>
</div>
<div class="content">
Przydatne pliki
