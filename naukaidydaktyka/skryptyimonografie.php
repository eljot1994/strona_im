...
<div class="menu">
    ...
    <div class="secondary_menu">
        ...
        <button class="dropBtn" onclick="location.href='skryptyimonografie.php'" style="background-color: #fff;color: #00507b">Skrypty i&nbspmonografie</button>
        <button class="dropBtn" onclick="location.href='konferencje.php'" >Konferencje</button>
