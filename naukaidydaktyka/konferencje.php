...
<div class="menu">
    <div class="primary_menu">
        <div class="dropdown">
            <button class="dropBtn" style="cursor: default" >Instytut</button>
            <div class="dropList">
        ...
        <div class="dropdown">
            <button class="dropBtn" style="cursor: default; background-color: #00507b">Nauka i dydaktyka</button>
            <div class="dropList">
                <a href="../naukaidydaktyka/tytulystopnienaukowe.php">Tytuły/Stopnie&nbspnaukowe</a>
    ...
    <div class="secondary_menu">
        <button class="dropBtn" onclick="location.href='tytulystopnienaukowe.php'" >Tytuły/Stopnie&nbspnaukowe</button>
        <button class="dropBtn" onclick="location.href='skryptyimonografie.php'" >Skrypty i&nbspmonografie</button>
        <button class="dropBtn" onclick="location.href='konferencje.php'" style="background-color: #fff;color: #00507b">Konferencje</button>
        <button class="dropBtn" onclick="location.href='seminaria.php'" >Seminaria</button>
        <button class="dropBtn" onclick="location.href='tematykabadawcza.php'" >Tematyka badawcza</button>
        <button class="dropBtn" onclick="location.href='projekty.php'" >Projekty</button>
    </div>
</div>
<div class="content">
Konferencje
