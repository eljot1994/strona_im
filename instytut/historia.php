...
<div class="menu">
    ...
    <div class="secondary_menu">
        ...
        <button class="dropBtn" onclick="location.href='zaklady.php'">Zakłady</button>
        <button class="dropBtn" onclick="location.href='historia.php'" style="background-color: #fff;color: #00507b">Historia</button>
